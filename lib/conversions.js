 ...
 * @sig Number -> String
 * @param {!number} seconds Number of seconds since the Unix epoch
 * @return {!number} ISO 8601-compliant representation
 ...
 * @category DateTime
 * @sig String -> DateTime
 * @param {!number} ISO 8601-compliant representation
 ...
 * @sig String -> DateTime
 * @param {!number} ISO 8601-compliant representation
 * @return {!number} milliseconds Number of milliseconds since the Unix epoch
