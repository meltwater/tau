...
export const fromDurationLikeWithOptions = toUnary(Duration.fromDurationLike)
export const fromDurationLike = withDefault(fromDurationLikeWithOptions)

export const durationInvalidWithExplanation = toBinary(Duration.invalid)
...
export const toHumanWithOptions = fromUnaryMethod('toHuman')
export const toHuman = withDefault(toHumanWithOptions)
