...
export const invalid = unary(DateTime.invalid)

export const local = apply(DateTime.local)
export const max = binary(DateTime.max)
export const min = binary(DateTime.min)
export const utc = apply(DateTime.utc)
