...
export const fromObject = toUnary(DateTime.fromObject)
...
export const resolvedLocaleOptsWithOptions = fromUnaryMethod(
  'resolvedLocaleOpts'
)
...
export const toRelativeCalendarWithOptions = fromUnaryMethod(
  'toRelativeCalendar'
)
